...
class ProductController extends Controller
{
    ...
    public function admin_products(Request $request)
    {
        ...
        return view('ControlPanel.products.index', compact('products','type', 'col_name', 'query', 'sort_search'));
    }
    ...
    public function seller_products(Request $request)
    {
        ...
        return view('ControlPanel.products.index', compact('products','type', 'col_name', 'query', 'seller_id', 'sort_search'));
    }
    ...
    public function admin_product_edit($id)
    {
        ...
        $categories = Category::all();
        return view('ControlPanel.products.edit', compact('product', 'categories', 'tags'));
    }
    ...
    public function get_products_by_brand(Request $request)
    {
        ...
        return view('ControlPanel.partials.product_select', compact('products'));
    }
    ...
    public function sku_combination(Request $request)
    {
        ...
        $combinations = combinations($options);
        return view('ControlPanel.partials.sku_combinations', compact('combinations', 'unit_price', 'colors_active', 'product_name'));
    }
    ...
    public function sku_combination_edit(Request $request)
    {
        ...
        $combinations = combinations($options);
        return view('ControlPanel.partials.sku_combinations_edit', compact('combinations', 'unit_price', 'colors_active', 'product_name', 'product'));
    }
