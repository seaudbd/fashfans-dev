...
class SubCategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('ControlPanel.subcategories.index', compact('subcategories', 'sort_search'));
    }
    ...
    public function create()
    {
        ...
        return view('ControlPanel.subcategories.create', compact('categories'));
    }
    ...
    public function edit($id)
    {
        ...
        $categories = Category::all();
        return view('ControlPanel.subcategories.edit', compact('categories', 'subcategory'));
    }
