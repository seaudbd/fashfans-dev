...
class PickupPointController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('ControlPanel.pickup_point.index', compact('pickup_points'));
    }
    ...
    {
        return view('ControlPanel.pickup_point.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('ControlPanel.pickup_point.edit', compact('pickup_point'));
    }
