        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-11 mx-auto">
                <div style="font-size: 12px; margin-bottom: 15px;">
                    <a href="{{ url('/') }}" class="text-decoration-none text-dark">Home</a> > <span style="color: #b1b0b9;">Designers</span>
                </div>
                <div style="position: relative; height: 460px; width: 100%; background-color: #f6f6f8;">
                    <img src="{{ asset('storage/images/designers/designers-1.png') }}" style="height: 460px; width: 100%;">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-11 py-5 mx-auto">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-9 col-xxl-10 ps-5">
                        ...
                        {{--<div class="row mb-5">--}}
                            {{--<div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6 pe-xxl-4 designer_content_holder">--}}
                                {{--<div class="designer_normal_view">--}}
                                    {{--<img src="{{ asset('storage/images/designers/7.jpg') }}" style="width: 100%; height: 575px;">--}}
                                {{--</div>--}}
                                {{--<div class="designer_hover_view ps-xxl-3 pt-4 d-none" style="position: relative;">--}}
                                    {{--<div style="position: absolute; top: 0; left: 50%; transform: translate(0, -50%); -ms-transform: translate(0, -50%);"><img src="{{ asset('storage/images/application/logo_7.png') }}"></div>--}}
                                    {{--<div><img src="{{ asset('storage/images/designers/7.jpg') }}" style="width: 100%; height: 375px;"></div>--}}
                                    {{--<div>--}}
                                        {{--<div class="row mt-3">--}}
                                            {{--<div class="col-8">--}}
                                                {{--<div class="d-inline-block me-3"><i class="far fa-heart"></i> <span class="likes_count">836 Likes</span></div>--}}
                                                {{--<div class="d-inline-block"><i class="far fa-comment-alt"></i> <span class="comments_count">736</span></div>--}}
                                            {{--</div>--}}
                                        ...
                                        {{--</div>--}}
                                        {{--<div class="mt-3">--}}
                                            {{--<span style="font-size: 20px; font-weight: 600; color: #020101; text-transform: uppercase;">Donna Karan</span>--}}
                                        {{--</div>--}}
                                        {{--<div class="mt-2">--}}
                                            {{--<span style="color: #020101;">Imply dummy text of the printing and typesetting industry</span>--}}
                                        {{--</div>--}}
                                    {{--</div>--}}
                                {{--</div>--}}
                            {{--</div>--}}
                            {{--<div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6 ps-xxl-4 designer_content_holder">--}}
                                {{--<div class="designer_normal_view">--}}
                                    {{--<img src="{{ asset('storage/images/designers/8.jpg') }}" style="width: 100%; height: 575px;">--}}
                                {{--</div>--}}
                                {{--<div class="designer_hover_view pe-xxl-3 pt-4 d-none" style="position: relative;">--}}
                                    {{--<div style="position: absolute; top: 0; left: 50%; transform: translate(0, -50%); -ms-transform: translate(0, -50%);"><img src="{{ asset('storage/images/application/logo_7.png') }}"></div>--}}
                                    {{--<div><img src="{{ asset('storage/images/designers/8.jpg') }}" style="width: 100%; height: 375px;"></div>--}}
                                    {{--<div>--}}
                                        {{--<div class="row mt-3">--}}
                                            {{--<div class="col-8">--}}
                                                {{--<div class="d-inline-block me-3"><i class="far fa-heart"></i> <span class="likes_count">836 Likes</span></div>--}}
                        ...
                        {{--<div class="row mb-5">--}}
                            {{--<div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6 pe-xxl-4 designer_content_holder">--}}
                                {{--<div class="designer_normal_view">--}}
                                    {{--<img src="{{ asset('storage/images/designers/3.jpg') }}" style="width: 100%; height: 575px;">--}}
                                {{--</div>--}}
                                {{--<div class="designer_hover_view ps-xxl-3 pt-4 d-none" style="position: relative;">--}}
                                    {{--<div style="position: absolute; top: 0; left: 50%; transform: translate(0, -50%); -ms-transform: translate(0, -50%);"><img src="{{ asset('storage/images/application/logo_7.png') }}"></div>--}}
                                    {{--<div><img src="{{ asset('storage/images/designers/3.jpg') }}" style="width: 100%; height: 375px;"></div>--}}
                                    {{--<div>--}}
                                        {{--<div class="row mt-3">--}}
                                            {{--<div class="col-8">--}}
                                                {{--<div class="d-inline-block me-3"><i class="far fa-heart"></i> <span class="likes_count">836 Likes</span></div>--}}
                            ...
                            {{--<div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6 ps-xxl-4 designer_content_holder">--}}
                                {{--<div class="designer_normal_view">--}}
                                    {{--<img src="{{ asset('storage/images/designers/4.jpg') }}" style="width: 100%; height: 575px;">--}}
                                {{--</div>--}}
                                {{--<div class="designer_hover_view pe-xxl-3 pt-4 d-none" style="position: relative;">--}}
                                    {{--<div style="position: absolute; top: 0; left: 50%; transform: translate(0, -50%); -ms-transform: translate(0, -50%);"><img src="{{ asset('storage/images/application/logo_7.png') }}"></div>--}}
                                    {{--<div><img src="{{ asset('storage/images/designers/4.jpg') }}" style="width: 100%; height: 375px;"></div>--}}
                                    {{--<div>--}}
                                        {{--<div class="row mt-3">--}}
                                            {{--<div class="col-8">--}}
                                                {{--<div class="d-inline-block me-3"><i class="far fa-heart"></i> <span class="likes_count">836 Likes</span></div>--}}
                        ...
                        {{--<div class="row mb-5">--}}
                            {{--<div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6 pe-xxl-4 designer_content_holder">--}}
                                {{--<div class="designer_normal_view">--}}
                                    {{--<img src="{{ asset('storage/images/designers/5.jpg') }}" style="width: 100%; height: 575px;">--}}
                                {{--</div>--}}
                                {{--<div class="designer_hover_view ps-xxl-3 pt-4 d-none" style="position: relative;">--}}
                                    {{--<div style="position: absolute; top: 0; left: 50%; transform: translate(0, -50%); -ms-transform: translate(0, -50%);"><img src="{{ asset('storage/images/application/logo_7.png') }}"></div>--}}
                                    {{--<div><img src="{{ asset('storage/images/designers/5.jpg') }}" style="width: 100%; height: 375px;"></div>--}}
                                    {{--<div>--}}
                                        {{--<div class="row mt-3">--}}
                                            {{--<div class="col-8">--}}
                                                {{--<div class="d-inline-block me-3"><i class="far fa-heart"></i> <span class="likes_count">836 Likes</span></div>--}}
                            ...
                            {{--<div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6 ps-xxl-4 designer_content_holder">--}}
                                {{--<div class="designer_normal_view">--}}
                                    {{--<img src="{{ asset('storage/images/designers/6.jpg') }}" style="width: 100%; height: 575px;">--}}
                                {{--</div>--}}
                                {{--<div class="designer_hover_view pe-xxl-3 pt-4 d-none" style="position: relative;">--}}
                                    {{--<div style="position: absolute; top: 0; left: 50%; transform: translate(0, -50%); -ms-transform: translate(0, -50%);"><img src="{{ asset('storage/images/application/logo_7.png') }}"></div>--}}
                                    {{--<div><img src="{{ asset('storage/images/designers/6.jpg') }}" style="width: 100%; height: 375px;"></div>--}}
                                    {{--<div>--}}
                                        {{--<div class="row mt-3">--}}
                                            {{--<div class="col-8">--}}
                                                {{--<div class="d-inline-block me-3"><i class="far fa-heart"></i> <span class="likes_count">836 Likes</span></div>--}}
                        ...
                        {{--<div class="row mb-5">--}}
                            {{--<div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6 pe-xxl-4 designer_content_holder">--}}
                                {{--<div class="designer_normal_view">--}}
                                    {{--<img src="{{ asset('storage/images/designers/1.jpg') }}" style="width: 100%; height: 575px;">--}}
                                {{--</div>--}}
                                {{--<div class="designer_hover_view ps-xxl-3 pt-4 d-none" style="position: relative;">--}}
                                    {{--<div style="position: absolute; top: 0; left: 50%; transform: translate(0, -50%); -ms-transform: translate(0, -50%);"><img src="{{ asset('storage/images/application/logo_7.png') }}"></div>--}}
                                    {{--<div><img src="{{ asset('storage/images/designers/1.jpg') }}" style="width: 100%; height: 375px;"></div>--}}
                                    {{--<div>--}}
                                        {{--<div class="row mt-3">--}}
                                            {{--<div class="col-8">--}}
                                                {{--<div class="d-inline-block me-3"><i class="far fa-heart"></i> <span class="likes_count">836 Likes</span></div>--}}
                            ...
                            {{--<div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6 ps-xxl-4 designer_content_holder">--}}
                                {{--<div class="designer_normal_view">--}}
                                    {{--<img src="{{ asset('storage/images/designers/2.jpg') }}" style="width: 100%; height: 575px;">--}}
                                {{--</div>--}}
                                {{--<div class="designer_hover_view pe-xxl-3 pt-4 d-none" style="position: relative;">--}}
                                    {{--<div style="position: absolute; top: 0; left: 50%; transform: translate(0, -50%); -ms-transform: translate(0, -50%);"><img src="{{ asset('storage/images/application/logo_7.png') }}"></div>--}}
                                    {{--<div><img src="{{ asset('storage/images/designers/2.jpg') }}" style="width: 100%; height: 375px;"></div>--}}
                                    {{--<div>--}}
                                        {{--<div class="row mt-3">--}}
                                            {{--<div class="col-8">--}}
                                                {{--<div class="d-inline-block me-3"><i class="far fa-heart"></i> <span class="likes_count">836 Likes</span></div>--}}
                        ...
                        {{--<div class="row">--}}
                            {{--<div class="col text-center">--}}
                                {{--<button type="button" style="height: 57px; width: 248px; border-radius: 5.65px; border: none; background: linear-gradient(270deg, #FA4A6F 0%, #FFA7E7 100%); color: #ffffff;">Load more</button>--}}
                            {{--</div>--}}
                        {{--</div>--}}
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                {{--success: function (result) {--}}
                    ...
                    {{--if (result.length > 0) {--}}
                        {{--let i = 0;--}}
                        {{--$.each(result, function (key, designer) {--}}
                            {{--if (key % 2 === 0) {--}}
                                {{--i++;--}}
                                {{--$('#designers_container').append('<div class="row mb-5" id="designers_row_' + i + '"></div>');--}}
                            {{--}--}}
                            {{--let normalImage = '{{ asset('storage') }}/' + designer.normal_image;--}}
                            {{--let hoverImage = '{{ asset('storage') }}/' + designer.hover_image;--}}
                            {{--let logo = '{{ asset('storage/images/application/logo_7.png') }}';--}}
                            {{--let paddingClassValue = (key % 2 === 0) ? 'pe-xxl-4' : 'ps-xxl-4';--}}
                            {{--$('#designers_row_' +  i).append(--}}
                                {{--'<div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6 ' + paddingClassValue + ' designer_content_holder">' +--}}
                                    {{--'<div class="designer_normal_view">' +--}}
                                    {{--'<img src="' + normalImage + '" class="img-fluid">' +--}}
                                    {{--'</div>' +--}}
                                    {{--'<div class="designer_hover_view ps-xxl-3 pt-4 d-none" style="position: relative; cursor: pointer;" data-designer_id="' + designer.id + '">' +--}}
                                    {{--'<div style="position: absolute; top: 0; left: 50%; transform: translate(0, -50%); -ms-transform: translate(0, -50%);"><img src="' + logo + '"></div>' +--}}
                                    {{--'<div><img src="' + hoverImage + '" class="img-fluid"></div>' +--}}
                                    {{--'<div>' +--}}
                                    {{--'<div class="row mt-3">' +--}}
                                    {{--'<div class="col-8">' +--}}
                                    {{--'<div class="d-inline-block me-3"><i class="far fa-heart"></i> <span class="likes_count">' + designer.likes_count + ' Likes</span></div>' +--}}
                                    {{--'<div class="d-inline-block"><i class="far fa-comment-alt"></i> <span class="comments_count">' + designer.message_count + '</span></div>' +--}}
                                    {{--'</div>' +--}}
                                    {{--'<div class="col-4 text-end">' +--}}
                                    {{--'<button type="button" class="btn btn-sm btn-outline-secondary fw-bold">Follow</button>' +--}}
                                    {{--'</div>' +--}}
                                    {{--'</div>' +--}}
                                    {{--'<div class="mt-3">' +--}}
                                    {{--'<span style="font-size: 20px; font-weight: 600; color: #020101; text-transform: uppercase;">' + designer.name + '</span>' +--}}
                                    {{--'</div>' +--}}
                                    {{--'<div class="mt-2">' +--}}
                                    {{--'<span style="color: #020101;">' + designer.description.substr(0, 100) + '</span>' +--}}
                                    {{--'</div>' +--}}
                                    {{--'</div>' +--}}
                                    {{--'</div>' +--}}
                                {{--'</div>'--}}
                        ...
                        {{--if (result.length === 4) {--}}
                            {{--$('#designers_container').append(--}}
                                {{--'<div class="row">' +--}}
                                {{--'<div class="col text-center">' +--}}
                                {{--'<button data-skip="' + (skip + 4) + '" data-limit="' + limit + '" id="designers_load_more" type="button" style="padding: 15px 100px; border-radius: 5px; border: none; background: linear-gradient(270deg, #FA4A6F 0%, #FFA7E7 100%); color: #ffffff;">Load more</button>' +--}}
                                {{--'</div>' +--}}
                                {{--'</div>'--}}
                            {{--);--}}
                        {{--}--}}
