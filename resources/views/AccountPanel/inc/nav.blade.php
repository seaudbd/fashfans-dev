            ...
            <div class="row">
                    ...
                    <ul class="inline-links d-lg-inline-block d-flex justify-content-between">
                        <li class="dropdown" id="lang-change">
                            ...
                            <a href="" class="dropdown-toggle top-bar-item" data-toggle="dropdown">
                                <img src="{{ asset('frontend/images/placeholder.jpg') }}" height="11" data-src="{{ asset('frontend/images/icons/flags/'.$locale.'.png') }}" class="flag lazyload" alt="{{ App\Models\Language::where('code', $locale)->first()->name }}"><span class="language">{{ App\Models\Language::where('code', $locale)->first()->name }}</span>
                            </a>
                ...
                <div class="col-5 text-right d-none d-lg-block">
                    <ul class="inline-links">
                        <li>
                            <a href="{{ route('newsfeed') }}" class="top-bar-item">{{__('News Feed')}}</a>
                        </li>
                        <li>
                        ...
                        @auth
                        <li>
                            <a href="{{ route('account.dashboard') }}" class="top-bar-item">{{__('My Panel')}}</a>
                        </li>
                        <li>
            ...
            <div class="side-menu closed">
                ...
                <div class="side-menu-list px-3">
                    <ul class="side-user-menu">
                        ...
                        @auth
                            @php
                                $conversation = App\Models\Conversation::where('sender_id', Auth::user()->id)->where('sender_viewed', '1')->get();
                            @endphp
        ...
        <nav class="navbar navbar-expand-lg navbar--bold navbar--style-2 navbar-light bg-default">
            <div class="container">
                <div class="collapse navbar-collapse align-items-center justify-content-center" id="navbar_main">
                    <!-- Navbar links -->
                    <ul class="navbar-nav">
                        @foreach (App\Models\Search::orderBy('count', 'desc')->get()->take(5) as $key => $search)
                            <li class="nav-item">
