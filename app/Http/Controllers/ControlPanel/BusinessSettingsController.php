...
class BusinessSettingsController extends Controller
{
    ...
    {
    	return view('ControlPanel.business_settings.activation');
    }

    public function social_login(Request $request)
    {
        return view('ControlPanel.business_settings.social_login');
    }

    public function smtp_settings(Request $request)
    {
        return view('ControlPanel.business_settings.smtp_settings');
    }

    public function google_analytics(Request $request)
    {
        return view('ControlPanel.business_settings.google_analytics');
    }

    public function facebook_chat(Request $request)
    {
        return view('ControlPanel.business_settings.facebook_chat');
    }

    public function payment_method(Request $request)
    {
        return view('ControlPanel.business_settings.payment_method');
    }
    ...
    {
    	return view('ControlPanel.business_settings.seller_verification_form');
    }
    ...
    public function vendor_commission(Request $request)
    {
        ...
        return view('ControlPanel.business_settings.vendor_commission', compact('business_settings'));
    }
