...
class GeneralSettingController extends Controller
{
    ...
    public function index()
    {
        ...
        return view("ControlPanel.general_settings.index", compact("generalsetting"));
    }

    public function logo()
    {
        $generalsetting = GeneralSetting::first();
        return view("ControlPanel.general_settings.logo", compact("generalsetting"));
    }
    ...
    {
        $generalsetting = GeneralSetting::first();
        return view("ControlPanel.general_settings.color", compact("generalsetting"));
    }
