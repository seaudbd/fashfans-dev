            ...
            <div class="form-group" id="subcategory">
               ...
               <div class="col-lg-9">
                  <select class="form-control subcategory_id demo-select2" name="subcategory_ids[]" required>
                      @foreach(\App\Models\SubCategory::where('category_id', $details->category_id)->get() as $key => $subcategory)
            ...
            <div class="form-group" id="subsubcategory">
               ...
               <div class="col-lg-9">
                  <select class="form-control subsubcategory_id demo-select2" name="subsubcategory_ids[]" required>
                      @foreach(\App\Models\SubSubCategory::where('sub_category_id', $details->subcategory_id)->get() as $key => $subsubcategory)
            ...
            <div class="form-group">
                ...
                <div class="col-lg-9">
                    <select name="product_ids[]" class="form-control product_id demo-select2" required>
                        @foreach(\App\Models\Product::where('subsubcategory_id', $details->subsubcategory_id)->get() as $key => $product)
