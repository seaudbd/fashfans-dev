...
class CurrencyController extends Controller
{
    ...
    public function currency(Request $request)
    {
        ...
        return view('ControlPanel.business_settings.currency', compact('currencies', 'active_currencies'));
    }
    ...
    {
        return view('ControlPanel.partials.currency_create');
    }

    public function edit(Request $request)
    {
        $currency = Currency::findOrFail($request->id);
        return view('ControlPanel.partials.currency_edit', compact('currency'));
    }
