...
class ConversationController extends Controller
{
    ...
    public function index()
    {
        if (BusinessSetting::where('type', 'conversation_system')->first()->value == 1) {
            ...
            return view('AccountPanel.conversations.index', compact('conversations'));
        }
        else {
    ...
    public function admin_index()
    {
        if (BusinessSetting::where('type', 'conversation_system')->first()->value == 1) {
            ...
            return view('ControlPanel.conversations.index', compact('conversations'));
        }
        else {
            flash(__('Conversation is disabled at this moment'))->warning();
            return back();
    ...
    public function admin_show($id)
    {
        ...
        $conversation->save();
        return view('ControlPanel.conversations.show', compact('conversation'));
    }
