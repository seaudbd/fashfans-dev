...
class BrandController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('ControlPanel.brands.index', compact('brands', 'sort_search'));
    }
    ...
    {
        return view('ControlPanel.brands.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('ControlPanel.brands.edit', compact('brand'));
    }
