...
class SellerWithdrawRequestController extends Controller
{
    ...
    public function request_index()
    {
        ...
        return view('ControlPanel.seller_withdraw_requests.index', compact('seller_withdraw_requests'));
    }
    ...
    public function payment_modal(Request $request)
    {
        ...
        return view('ControlPanel.seller_withdraw_requests.payment_modal', compact('seller', 'seller_withdraw_request'));
    }
    ...
    public function message_modal(Request $request)
    {
        ...
        elseif (Auth::user()->user_type == 'admin' || Auth::user()->user_type == 'staff') {
            return view('ControlPanel.seller_withdraw_requests.withdraw_message_modal', compact('seller_withdraw_request'));
        }
    }
}
