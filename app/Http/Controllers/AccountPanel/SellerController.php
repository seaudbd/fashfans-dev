...
class SellerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('ControlPanel.sellers.index', compact('sellers', 'sort_search', 'approved'));
    }
    ...
    {
        return view('ControlPanel.sellers.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('ControlPanel.sellers.edit', compact('seller'));
    }
    ...
    {
        $seller = Seller::findOrFail($id);
        return view('ControlPanel.sellers.verification', compact('seller'));
    }
    ...
    public function payment_modal(Request $request)
    {
        ...
        return view('ControlPanel.sellers.payment_modal', compact('seller'));
    }
    ...
    public function profile_modal(Request $request)
    {
        $seller = Seller::findOrFail($request->id);
        //return $seller;
        return view('ControlPanel.sellers.profile_modal', compact('seller'));
    }
