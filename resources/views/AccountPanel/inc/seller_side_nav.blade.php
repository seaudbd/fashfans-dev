    ...
    <div class="widget mb-0">
        ...
        <div class="widget-profile-menu py-3">
            <ul class="categories categories--style-3">
                ...
                <li>
                    <a href="{{ route('account.dashboard') }}" class="{{ areActiveRoutesHome(['dashboard'])}}">
                ...
                @if (App\Models\BusinessSetting::where('type', 'conversation_system')->first()->value == 1)
                    @php
                        $conversation_sent = App\Models\Conversation::where('sender_id', Auth::user()->id)->where('sender_viewed', 0)->get();
