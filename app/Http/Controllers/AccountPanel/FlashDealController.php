...
class FlashDealController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('ControlPanel.flash_deals.index', compact('flash_deals', 'sort_search'));
    }
    ...
    {
        return view('ControlPanel.flash_deals.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('ControlPanel.flash_deals.edit', compact('flash_deal'));
    }
    ...
    public function product_discount(Request $request){
        ...
        return view('ControlPanel.partials.flash_deal_discount', compact('product_ids'));
    }

    public function product_discount_edit(Request $request){
        $product_ids = $request->product_ids;
        $flash_deal_id = $request->flash_deal_id;
        return view('ControlPanel.partials.flash_deal_discount_edit', compact('product_ids', 'flash_deal_id'));
    }
}
