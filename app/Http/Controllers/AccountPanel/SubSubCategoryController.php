...
class SubSubCategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('ControlPanel.subsubcategories.index', compact('subsubcategories', 'sort_search'));
    }
    ...
    public function create()
    {
        ...
        $brands = Brand::all();
        return view('ControlPanel.subsubcategories.create', compact('categories', 'brands'));
    }
    ...
    public function edit($id)
    {
        ...
        $categories = Category::all();
        $brands = Brand::all();
        return view('ControlPanel.subsubcategories.edit', compact('subsubcategory', 'categories', 'brands'));
    }
